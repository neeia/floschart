...
export const initialNodes: Node[] = [
  ...
  },
  {
    ...
    data: {
      ...
      name: "foo",
      notes:
        "bar bar bar bar bar bar bar bar bar bar bar bar bar bar bar barbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbarbar bar",
      target: 99,
      current: 80,
      outgoing: new Set(),
      incoming: {},
    ...
    data: {
      ...
      items: [
        ...
        { name: "Mine some Granite.", completed: true },
        {
          ...
          completed: true,
          notes: "The spell must be cast outside of a desert settlement.",
        },
        ...
        },
        {
          ...
          completed: true,
          notes:
            "This weapon only has to be equipped as it dies, allowing you to deal damage with other weapons.",
        },
        {
          name: "Burn some yew logs on the Nardah Mayor's balcony.",
          completed: true,
          notes: "He lives directly east of the central fountain.",
        },
        {
          name: "Create a Mithril Platebody in Nardah.",
          completed: false,
          notes: "The anvil is found in the westernmost building.",
        },
      ],
      tier: "Hard",
